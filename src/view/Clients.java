...
public class Clients extends JPanel {
	...
	// TODO Remplir la table "ClientsTable" au chargement du panel (Colonnes : Nom, Prenom et Solde)
	void OnLoadFillClientsTable()
	{
		
	}
	
	// TODO Afficher toutes les infos d'un client lorsque la ligne dans "ClientsTable est selectionnée en s'aidant des différents labels (nom, prenom, adresse, ville, solde, nbCmd)
	// Par défaut afficher le client à l'index 0
